/**
 * Browser-trust fence for the /session-manager routes, behaviorally identical
 * to the /api gateway's fence (and to dsh-better-sidebar's copy of it):
 ...
 * authentication. The plugin copies the small helper instead of depending on
 * package internals.
 */
import type { HttpRequestLike } from './types.ts'
 ...
 */
export function isTrustedApiRequest(request: HttpRequestLike, trustedHosts: readonly string[]): boolean {
